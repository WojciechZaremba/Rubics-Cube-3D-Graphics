...
const sounds = {
    0: new Audio("./sounds/cube_turn_0.mp3"),
    1: new Audio("./sounds/cube_turn_1.mp3"),
    2: new Audio("./sounds/cube_turn_2.mp3"),
    3: new Audio("./sounds/cube_turn_3.mp3"),
    4: new Audio("./sounds/cube_turn_4.mp3"),
    5: new Audio("./sounds/cube_turn_5.mp3"),
    6: new Audio("./sounds/cube_turn_6.mp3"),
    7: new Audio("./sounds/cube_turn_7.mp3"),
    8: new Audio("./sounds/cube_turn_8.mp3"),
    9: new Audio("./sounds/cube_turn_9.mp3"),
    10: new Audio("./sounds/cube_turn_10.mp3"),
    11: new Audio("./sounds/cube_turn_11.mp3"),
    12: new Audio("./sounds/cube_turn_12.mp3"),
    13: new Audio("./sounds/cube_turn_13.mp3"),
    14: new Audio("./sounds/cube_turn_14.mp3"),
    15: new Audio("./sounds/cube_turn_15.mp3"),
    16: new Audio("./sounds/cube_turn_16.mp3"),
}
